...
// Extract user data
$adminName = $user['username'];  // Use the username as the admin's name
$profilePic = $user['profile_picture']; // Assuming the profile picture path is stored in the 'profile_picture' column
...
<nav class="navbar navbar-expand-lg" style="background-color:rgb(50, 69, 111);">
  <div class="container-fluid">
    <div class="collapse navbar-collapse show" id="navbarLinks">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item">
          <a class="nav-link text-white mx-3" href="add_medicine.php">Add Medicine</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white mx-3" href="view_medicines.php">View Medicine</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white mx-3" href="add_user.php">Add User</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white mx-3" href="view_users.php">View User</a>
        </li>
        <li class="nav-item">
  ...
  <!-- <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="Untitled design.png" class="d-block w-100 carousel-img" alt="First Slide">
      </div>
  ...
  <div class="container my-4">
    <h2 class="text-center fw-bold" style="color: #2A3D66;">Welcome to Admin Dashboard</h2>
  </div>
  ...
  <div class="row g-4">
    <div class="col-md-4">
      <a href="add_medicine.php" class="text-decoration-none">
        <div class="card text-center card-custom shadow">
          <div class="card-body">
            <img src="add_medicine.png" class="img-fluid mb-3" style="max-height: 100px;" alt="Add Medicine">
            <h5 class="card-title fw-bold">Add Medicine</h5>
          </div>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a href="view_medicines.php" class="text-decoration-none">
        <div class="card text-center card-custom shadow">
          <div class="card-body">
            <img src="view_medicines.png" class="img-fluid mb-3" style="max-height: 100px;" alt="View Medicines">
    ...
    <div class="col-md-4">
      <a href="add_user.php" class="text-decoration-none">
        <div class="card text-center card-custom shadow">
          <div class="card-body">
            <img src="add_user.png" class="img-fluid mb-3" style="max-height: 100px;" alt="Add User">
    ...
    <div class="col-md-4">
      <a href="view_users.php" class="text-decoration-none">
        <div class="card text-center card-custom shadow">
          <div class="card-body">
            <img src="view_users.png" class="img-fluid mb-3" style="max-height: 100px;" alt="View Users">
    ...
    <div class="col-md-4">
      <a href="sales_history.php" class="text-decoration-none">
        <div class="card text-center card-custom shadow">
          <div class="card-body">
            <img src="sales_history.png" class="img-fluid mb-3" style="max-height: 100px;" alt="Sales History">
  ...
  <div class="container my-5">
    <div class="p-4 rounded shadow-sm" style="background-color: #F9F9F9;">
      ...
      <p style="color: #333; line-height: 1.7;">
        The MediTrack is an intuitive and efficient platform designed to simplify the operations of pharmacies and healthcare businesses. This dashboard enables administrators to seamlessly add and manage medicines, users, customers, and sales records, all in one place. The primary goal is to streamline the inventory process and minimize human error by offering an automated and easy-to-navigate interface.
        <br><br>
